...
cols = ['r','g','b','k','c','m'];
plotNames = {'Smarticles','Gait','Staple','Flat','Tetris','Vib','Vib Angle'};
plotTypes = [1];
figure(1);
...
% flowRate = diff(data(:,2))./diff(data(:,1));
plotNames = {'Flow Rate','Flow Rate Avged','Gait','Staple','Flat','Tetris','Vib','Vib Angle'};
plotTypes = [1,2];
...
plotTypes=[plotTypes, (gg(i,2)+2)]
end
legend([sp2(1:end)],plotNames(plotTypes));
